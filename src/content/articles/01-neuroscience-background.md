...
This is a placeholder *draft* article to prove the pipeline.

## Outline (we can refine)

1. What a spike is (and isn’t)
2. What you can record vs what you can stimulate
3. Peripheral nerve vs cortex: geometry, cell types, failure modes
4. Why interfaces become a materials + mechanics problem
