...
1) **Indications and trial design**
What is the first target (stroke rehab, epilepsy, movement disorders, etc.) and what are the endpoints?

2) **Closed-loop performance**
How are biomarkers defined, detected, and used to control stimulation in real time?

3) **Device practicality**
