...
1) *Signal stability vs time* (weeks → months → years)
2) *Surgical workflow* for very soft probes (tooling, reliability, placement repeatability)
3) *Failure modes* (buckling, delamination, encapsulation, connector issues)
